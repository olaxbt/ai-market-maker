...
def verify_installation():
    ...
    if sys.version_info >= (3, 11):
        ...
        checks.append(("❌", f"Python {sys.version_info.major}.{sys.version_info.minor} (3.11+ required)"))
...
def main():
    ...
    parser.add_argument("--symbols", default="BTC/USDT", help="Symbols for backtest (default: BTC/USDT)")
